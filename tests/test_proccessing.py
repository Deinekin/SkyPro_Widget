...
@pytest.fixture
def list_dicts_with_input_data():
...
def test_get_list_by_key(list_dicts_with_input_data, state, expected):
    assert get_list_by_key(list_dicts_with_input_data, key=state) == expected
...
def test_sort_by_date(list_dicts_with_input_data, by_raise, expected):
    assert sort_by_date(list_dicts_with_input_data, by_raise=by_raise) == expected
